...
# python train.py --gpu 0,1 --save-path "./experiments/CIFAR_FS_ProtoNet_baseline" --train-shot 5 \
# --head ProtoNet --network ProtoNet --dataset CIFAR_FS

python train.py --gpu 0,1 --save-path "./experiments/CIFAR_FS_ProtoNet_ResNet12_baseline" --train-shot 5 \
--head ProtoNet --network ResNet --dataset CIFAR_FS
python test.py --gpu 0  --episode 1000 --way 5 --shot 1 --query 15 \
  --head ProtoNet --network ResNet --dataset CIFAR_FS \
  --load ./experiments/CIFAR_FS_ProtoNet_ResNet12_baseline/epoch_21.pth;python test.py --gpu 0  --episode 1000 --way 5 --shot 5 --query 15 \
  --head ProtoNet --network ResNet --dataset CIFAR_FS \
  --load ./experiments/CIFAR_FS_ProtoNet_ResNet12_baseline/epoch_21.pth;


# Joint train from scratch
python train_film.py --gpu 0,1 \
  --save-path ./experiments/CIFAR_FS_ProtoNet_FiLM-SVM-WGrad_dual-BN \
  --save-epoch 10 --train-shot 5 --dataset CIFAR_FS --val-episodes-per-batch 4 \
  --head ProtoNet --network ResNet_FiLM \
  --task-embedding FiLM_SVM_WGrad --dual-BN


load_model=./experiments/CIFAR_FS_ProtoNet_FiLM-SVM-WGrad_dual-BN/epoch_25.pth; python test_film.py --gpu 0 \
...
python train_film.py --gpu 0,1 \
  --save-path ./experiments/CIFAR_FS_ProtoNet_FiLM-SVM-WGrad_dual-BN_load-naive_msgan1e-6_lr0.01 \
  --save-epoch 10 --train-shot 5 --dataset CIFAR_FS --val-episodes-per-batch 4 \
  --head ProtoNet --network ResNet_FiLM \
  --task-embedding FiLM_SVM_WGrad --dual-BN --lr 0.01 \
  --film-reg-type MSGAN --film-reg-level 1e-6 \
  --load-naive-backbone --load ./experiments/CIFAR_FS_ProtoNet_ResNet12_baseline/epoch_25.pth


load_model=./experiments/CIFAR_FS_ProtoNet_FiLM-SVM-WGrad_dual-BN_load-naive_msgan1e-6_lr0.01/epoch_24.pth; python test_film.py --gpu 0 \
  --episode 1000 --way 5 --shot 1 --query 15 --dataset CIFAR_FS \
  --head ProtoNet --network ResNet_FiLM \
  --task-embedding FiLM_SVM_WGrad --dual-BN \
  --load $load_model;python test_film.py --gpu 0 \
...
python train_film.py --gpu 0,1 \
  --save-path ./experiments/CIFAR_FS_ProtoNet_FiLM-SVM-WGrad_dual-BN_load-naive_train-film-dualBN_lr0.01 \
  --save-epoch 10 --train-shot 5 --dataset CIFAR_FS --val-episodes-per-batch 4 \
  --head ProtoNet --network ResNet_FiLM \
...
load_model=./experiments/CIFAR_FS_ProtoNet_FiLM-SVM-WGrad_dual-BN_load-naive_train-film-dualBN_lr0.01/epoch_25.pth; python test_film.py --gpu 0 \
  --episode 1000 --way 5 --shot 1 --query 15 --dataset CIFAR_FS \
  --head ProtoNet --network ResNet_FiLM \
  --task-embedding FiLM_SVM_WGrad --dual-BN \
  --load $load_model;python test_film.py --gpu 0 \
...
python train_film.py --gpu 0,1 \
  --save-path ./experiments/CIFAR_FS_ProtoNet_FiLM-SVM-WGrad_dual-BN_load-naive_train-film-dualBN_msgan1e-6_lr0.01 \
  --save-epoch 10 --train-shot 5 --dataset CIFAR_FS --val-episodes-per-batch 4 \
  --head ProtoNet --network ResNet_FiLM \
  --task-embedding FiLM_SVM_WGrad --dual-BN --train-film-dualBN --lr 0.01 \
  --film-reg-type MSGAN --film-reg-level 1e-6 \
...
load_model=./experiments/CIFAR_FS_ProtoNet_FiLM-SVM-WGrad_dual-BN_load-naive_train-film-dualBN_msgan1e-6_lr0.01/epoch_25.pth; python test_film.py --gpu 0 \
  --episode 1000 --way 5 --shot 1 --query 15 --dataset CIFAR_FS \
  --head ProtoNet --network ResNet_FiLM \
  --task-embedding FiLM_SVM_WGrad --dual-BN \
  --load $load_model;python test_film.py --gpu 0 \
...
python train_film.py --gpu 0,1 \
  --save-path ./experiments/CIFAR_FS_MetaOptNet_SVM_FiLM-SVM-WGrad_dual-BN_load-naive \
  --save-epoch 10 --train-shot 5 --dataset CIFAR_FS --val-episodes-per-batch 4 \
  --head SVM --network ResNet_FiLM \
  --task-embedding FiLM_SVM_WGrad --dual-BN \
...
python train_film.py --gpu 0,1 \
  --save-path ./experiments/CIFAR_FS_MetaOptNet_SVM_FiLM-SVM-WGrad_dual-BN_load-naive_train-film-dualBN \
  --save-epoch 10 --train-shot 5 --dataset CIFAR_FS --val-episodes-per-batch 4 \
  --head SVM --network ResNet_FiLM \
